 ...
 *
 * Scalar accumulation, OpenMP variant. Same accumulate loop as the serial
 * scalar kernel, parallelized over output rows by the OpenMP driver.
 */
...
#define RVSP_KERNEL_NAME rvsp_spgemm_scalar_omp_f32
#include "gustavson_core_omp_f32.inc"