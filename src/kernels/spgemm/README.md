...
```text
rvsp_v2.h                 public API
rvsp_v2_common.h          workspace and compiler helpers
rvsp_v2_sort.h            shared column sort
gustavson_core_f32.inc    shared SpGEMM driver

rvsp_v2_support.c         workspace query and CSR validation
rvsp_v2_symbolic.c        symbolic count and fill
